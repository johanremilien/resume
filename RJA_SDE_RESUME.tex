...
\extrainfo{\textcolor{color0}{\textbf{Software Development Engineer Qt $|$ C++ $|$ QML}}}
...
{
\begin{itemize}
	\item Development and enhancement of an \href{https://www.eurocontrol.int/asterix}{ASTERIX} message-processing multithreaded  library.
\end{itemize}
...
\cvitem{Dog Walking}{Reflecting and brainstorming innovative solutions during walks with my canine companion, Denver.}
\cvitem{Self-Improvement Books}{Reading to enhance personal growth, mindfulness, and problem-solving skills.}
\cvitem{Kayaking}{Enjoying the outdoors, staying active, and finding tranquility while kayaking on calm waters.}
